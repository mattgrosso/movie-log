...
- **A 2-contestant tie is unchanged in effect** — round-robin on 2 entries is exactly 1 match, so the common case behaves identically to the old pairwise flow; the tournament machinery is simply invisible overhead for it.
